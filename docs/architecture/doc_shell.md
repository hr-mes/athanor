...
|---|---|---|
| **2a. Compositor client** | `athanor-compositor-client` (SH2): windows, workspaces, outputs with their shape, actions and events in our own types; the reading of `CosmicTheme` moved into it from `athanor-style`; the boundary check in `scripts/verify.py` | P4 |
